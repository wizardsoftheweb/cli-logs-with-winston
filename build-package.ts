...
const tmp = path.join(__dirname, ".logsWithWinstonCliTmp");
...
// Type definitions for cli-logs-with-winston ${config.version.replace(/\.\d+$/, "")}
...
declare namespace LogsWithWinston {
    ${declaration}
}

export = LogsWithWinston;
`
